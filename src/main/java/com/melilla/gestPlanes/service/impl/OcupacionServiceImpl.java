...
public class OcupacionServiceImpl implements OcupacionService {
	...
	public Ocupacion crearOcupacion(CrearOcupacionDTO ocupacion) {
		...
		Categoria cat = categoriaRepository.findById(ocupacion.getIdCategoria())
				.orElseThrow(() -> new CategoriaNotFoundException(ocupacion.getIdCategoria()));
	...
	public Ocupacion editarOcupacion(EditarOcupacionDTO ocupacion) {
		...
		Ocupacion ocup = ocupacionRepository.findById(ocupacion.getIdOcupacion())
				.orElseThrow(() -> new OcupacionNotFoundException(ocupacion.getIdOcupacion()));
